locale = {
  ...
  translation = {
    ["%d skusenosti za hodinu"] = false,
    ["%s dokoncil ziadost"] = false,
    ["%s sa pripojil"] = false,
    ["%s sa odpojil."] = false,
    ["%s zostavajucich skusenosti"] = false,
    ["%s: (use object on target)"] = "%s: (pouzi predmet na ciel)",
    ["%s: (use object on yourself)"] = "%s: (pouzi predmet na sebe)",
    ["%s: (use object with crosshair)"] = "%s: (pouzi predmet s mieritkom)",
    ["%s: (use object)"] = "%s: (pouzi predmet)",
    ["(ERROR %d)"] = false,
    ["1a) Offensive Name"] = "1a) Urazlive meno",
    ["1b) Invalid Name Format"] = "1b) Nespravny format mena",
    ["1c) Unsuitable Name"] = "1c) Nevhodne meno",
    ["1d) Name Inciting Rule Violation"] = "1d) Meno porusuje pravidla",
    ["2a) Offensive Statement"] = "2a) Urazlive vyhlasenie",
    ["2b) Spamming"] = "2b) Spamovanie",
    ["2c) Illegal Advertising"] = "2c) Nelegalne Reklamy",
    ["2d) Off-Topic Public Statement"] = "2d) Verejne vyhlasenie mimo temy",
    ["2e) Non-English Public Statement"] = "2e) Neanglicke verejne vyhlasenie",
    ["2f) Inciting Rule Violation"] = "2f) Podnesovanie k poruseniu pravidlam",
    ["3a) Bug Abuse"] = "3a) Zneuzivanie chyb",
    ["3b) Game Weakness Abuse"] = "3b) Zneuzivanie slabosti hry",
    ["3c) Using Unofficial Software to Play"] = "3c) Pouzivanie neoficialneho softweru na hranie",
    ["3d) Hacking"] = "3d) Hackovanie",
    ["3e) Multi-Clienting"] = "3e) Uzivanie Multi-Klienta",
    ["3f) Account Trading or Sharing"] = "3f) Obchodovanie s uctom alebo zdielanie",
    ["4a) Threatening Gamemaster"] = "4a) Ohrozujuci Gamemaster",
    ["4b) Pretending to Have Influence on Rule Enforcement"] = "4b) Predstieranie ze ma vpliv na presadzovanie pravidiel",
    ["4c) False Report to Gamemaster"] = "4c) Falosne hlasenie Gamemastrovi",
    ["Accept"] = "Prijmi",
    ["Account name"] = "Cislo uctu",
    ["Account Status"] = "Stav uctu",
    ["Action"] = "Akcia",
    ["Action:"] = "Akcia:",
    ["Activate ignorelist"] = false,
    ["Activate whitelist"] = false,
    ["Add new server"] = "Pridaj novy server",
    ["Add new VIP"] = "Novy VIP",
    ["Add to VIP list"] = "Pridaj do VIP",
    ["Add"] = "Pridaj",
    ["Addon 1"] = "Addon 1",
    ["Addon 2"] = "Addon 2",
    ["Addon 3"] = "Addon 3",
    ["Adjust volume"] = "Zmen hlasitost",
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = false,
    ["All modules and scripts were reloaded."] = "Vsetky moduli boli obnovene",
    ["All"] = "Vsetky",
    ...
    ["Ambient light: %s%%"] = "Okolite svetlo: %s%%",
    ["Amount"] = "Suma",
    ["Amount:"] = "Suma:",
    ["Anonymous"] = "Anonymny",
    ["Any"] = "Akykolvek",
    ["Are you sure you want to logout?"] = "Si si isty ze sa chces odpojit?",
    ["Attack"] = "Utok",
    ["Auction End"] = false,
    ["Audio"] = "Zvuk",
    ["Authenticator Token"] = false,
    ["Author"] = "Autor",
    ["Auto login selected character on next charlist load"] = "Automaticke prihlasenie vybraneho hraca pri dalsom nacitani zoznamu",
    ["Auto login"] = "Prihlasit automaticky",
    ["Autoload priority"] = "Priorita automatickeho nacitania",
    ["Autoload"] = "Automaticke nacitanie",
    ...
    ["Browse Field"] = false,
    ["Browse"] = "Prehladavat",
    ["Bug report sent."] = "Hlasenie o chybe bolo odoslane.",
    ["Button Assign"] = "Priradit tlacitko",
    ["Buy Now"] = "Kup Teraz",
    ["Buy Offers"] = "Kupit ponuky",
    ["Buy with backpack"] = "Kup s batohom",
    ["Buy"] = "Kup",
    ["Buyer Name"] = false,
    ["Cancel"] = "Zrusit",
    ["Cannot login while already in game."] = "Nie je mozne sa prihlasit ked ste v hre",
    ["Cap"] = "Cap",
    ["Capacity"] = "Kapacita",
    ["Center"] = "Stred",
    ...
    ["Channels"] = "Kanaly",
    ["Character List"] = "Zoznam postav",
    ["Classic control"] = "Klasicke ovladanie",
    ["Clear current message window"] = "Vycistit aktualne okno",
    ["Clear Messages"] = "Vymazat spravy",
    ["Clear object"] = "Vymazat predmet",
